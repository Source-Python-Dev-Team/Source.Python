...
# ------------------------------------------------------------------
Add_Definitions(-DCOMPILER_MSVC -DCOMPILER_MSVC32 -D_WIN32 -DWIN32)

# ------------------------------------------------------------------
# Release flags.
# ------------------------------------------------------------------
Set(CMAKE_CXX_FLAGS "/D_NDEBUG /MD /wd4005 /MP /EHsc")
...
Set_Target_Properties(core PROPERTIES
    LINK_FLAGS "/NODEFAULTLIB:LIBC.lib /NODEFAULTLIB:LIBCMT.lib /NODEFAULTLIB:LIBCPMT.lib"
)
...
Set(SOURCEPYTHON_LINK_LIBRARIES
    ...
    ${PYTHONSDK_LIB}/python35.lib
    ${BOOSTSDK_LIB}/libboost_python-vc100-mt-1_55.lib
)
