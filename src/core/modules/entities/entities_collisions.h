...
//-----------------------------------------------------------------------------
struct CollisionPairHash_t
{
	inline std::size_t operator()(CollisionPair_t const &p) const {
		std::size_t s = 0;
...
typedef boost::unordered_set<CollisionPair_t, CollisionPairHash_t, CollisionPairEquals_t> CollisionPairs_t;
