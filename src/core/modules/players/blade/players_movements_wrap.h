...
#ifndef _PLAYERS_MOVEMENTS_BLADE_WRAP_H
#define _PLAYERS_MOVEMENTS_BLADE_WRAP_H
...
{
	// Properties...
	GameMovement.NOT_IMPLEMENTED_ATTR("proximity_mins");
	GameMovement.NOT_IMPLEMENTED_ATTR("proximity_maxs");
	GameMovement.NOT_IMPLEMENTED_ATTR("frame_time");
...
#endif // _PLAYERS_MOVEMENTS_BLADE_WRAP_H
