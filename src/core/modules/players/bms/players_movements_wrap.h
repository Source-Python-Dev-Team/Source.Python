...
#ifndef _PLAYERS_MOVEMENTS_BMS_WRAP_H
#define _PLAYERS_MOVEMENTS_BMS_WRAP_H
...
void export_engine_specific_game_movement(T _movements, U GameMovement)
{
	...
	GameMovement.def("get_player_view_offset", &CGameMovementWrapper::GetPlayerViewOffset);
...
#endif // _PLAYERS_MOVEMENTS_BMS_WRAP_H
