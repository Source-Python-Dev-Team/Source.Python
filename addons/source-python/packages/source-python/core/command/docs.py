...
# >> DESCRIPTIONS
# =============================================================================
_sp_docs = TypedServerCommand.parser.get_node(['sp', 'docs'])
_sp_docs.description = 'Documentation specific commands.'
