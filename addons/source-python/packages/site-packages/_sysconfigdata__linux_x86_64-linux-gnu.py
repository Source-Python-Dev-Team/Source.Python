...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/opt/py_build/bin',
    'BINLIBDEST': '/opt/py_build/lib/python3.13',
    'BLDLIBRARY': '-L. -lpython3.13',
    'BLDSHARED': 'gcc -pthread -shared -m32',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    ...
    'CC': 'gcc -pthread',
    'CCSHARED': '-fPIC',
    'CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -m32',
    ...
    'CONFIG_ARGS': "'--prefix=/opt/py_build' '--enable-shared' 'CFLAGS=-m32' 'LDFLAGS=-m32'",
    'CONFINCLUDEDIR': '/opt/py_build/include',
    'CONFINCLUDEPY': '/opt/py_build/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/opt/Python-3.13.2/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/opt/Python-3.13.2/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include',
    'CXX': 'g++ -pthread',
    'DESTDIRS': '/opt/py_build /opt/py_build/lib /opt/py_build/lib/python3.13 /opt/py_build/lib/python3.13/lib-dynload',
    'DESTLIB': '/opt/py_build/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/opt/py_build/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/opt/py_build/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/opt/py_build/include /opt/py_build/include /opt/py_build/include/python3.13 /opt/py_build/include/python3.13',
    'INCLUDEDIR': '/opt/py_build/include',
    'INCLUDEPY': '/opt/py_build/include/python3.13',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'g++ -pthread -shared -m32',
    'LDFLAGS': '-m32',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.so',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'gcc -pthread -shared -m32',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/opt/py_build/lib/python3.13',
    'LIBDIR': '/opt/py_build/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -m32 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -m32 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_32=1 -DANSI=1 -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -m32 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/opt/py_build/lib/pkgconfig',
    'LIBPL': '/opt/py_build/lib/python3.13/config-3.13-x86_64-linux-gnu',
    'LIBPYTHON': '',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/opt/py_build/lib/python3.13',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/opt/py_build/share/man',
    'MIMALLOC_HEADERS': '\\',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -m32 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -m32',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -m32 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-m32',
    'PY_CPPFLAGS': '-I. -I./Include',
    'PY_ENABLE_SHARED': 1,
    'PY_LDFLAGS': '-m32',
    'PY_LDFLAGS_NODIST': '',
    'PY_LDFLAGS_NOLTO': '-m32',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
    'PY_SQLITE_HAVE_SERIALIZE': 0,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -m32 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC',
    'PY_SUPPORT_TIER': 1,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
    ...
    'RESSRCDIR': '',
    'RETSIGTYPE': 'void',
    'RUNSHARED': 'LD_LIBRARY_PATH=/opt/Python-3.13.2',
    'SCRIPTDIR': '/opt/py_build/lib',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'LD_LIBRARY_PATH=/opt/Python-3.13.2 ./python -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'LD_LIBRARY_PATH=/opt/Python-3.13.2 ./python -E -m test',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './opt/py_build',
    'WASM_STDLIB': './opt/py_build/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 1,
    ...
    'abs_builddir': '/opt/Python-3.13.2',
    'abs_srcdir': '/opt/Python-3.13.2',
    'datarootdir': '/opt/py_build/share',
    'exec_prefix': '/opt/py_build',
    'prefix': '/opt/py_build',
    'srcdir': '.',
}
