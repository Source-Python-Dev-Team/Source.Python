...
# -*- coding: utf-8 -*-
#
#  Source.Python documentation build configuration file, created by
...
htmlhelp_basename = 'SourcePythondoc'
...
latex_documents = [
  (master_doc, 'SourcePython.tex', ' Source.Python Documentation',
   ' Source.Python Development Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'sourcepython', ' Source.Python Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'SourcePython', ' Source.Python Documentation',
   author, 'SourcePython', 'One line description of project.',
   'Miscellaneous'),
]
